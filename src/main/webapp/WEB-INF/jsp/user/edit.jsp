    ...
    <section class="content">
      ...
      <div class="box box-success">
        <div class="box-body">
            <!-- 表单 -->
             <!-- form start -->
            <form id="user" class="form-horizontal" action="${pageContext.request.contextPath}/users/${user.id}" method="post">
              ...
              <div class="box-body">
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input id="name" name="name" class="form-control" data-bv-notempty="true" placeholder="姓名" type="text" value="${user.name}"/>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input id="loginName" name="loginName" class="form-control" data-bv-notempty="true" placeholder="登录名" type="text" value="${user.loginName}"/>
                    </div>
                  </div>   
                </div>
              </div>
